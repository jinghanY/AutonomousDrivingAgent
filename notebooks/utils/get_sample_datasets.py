...
if __name__ == "__main__":
    COIL_DATASET_PATH = 'datasets/'
    print("Current directory:", os.listdir('.'))
    try:
        if not os.listdir(COIL_DATASET_PATH):
            print("No datasets found, downloading dataset now (may take some time).")
        else:
            print("Datasets directory not empty. Will not download new datasets.")
    except FileNotFoundError as e:
        print("{} directory not found".format(COIL_DATASET_PATH))
        print("Please fix COIL_DATASET_PATH before trying again.")
        raise e
    ...
    destination_final = COIL_DATASET_PATH
