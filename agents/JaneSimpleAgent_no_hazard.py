...
class JaneSimpleAgent(AutonomousAgent):
    ...
    def setup(self, path_to_conf_file):
        ...
        self.PATH='../torch_models/Jane_torch_v9_1000'
        self.model.load_state_dict(torch.load(self.PATH))
        self.model = self.model.to(self.device)
        self.model.eval()

        print("Loaded model:", self.PATH)
        print(os.getcwd())
    ...
    def run_step(self, input_data):
        ...
        if input_data['rgb'][0] % self.viz_fps == 0:
            ...
            print("Final (Steer, Throttle, Brake):", steer, throttle, brake)
            print("Final (Speed, Handbrake):", speed[0], hand_brake)
        return control
